...
| `js/data-year-makers.js` | `MONTHS_MAKERS`, `Q_MAKERS` — the second track. **60 of 366 written** |
...
**The Makers: 60 of 366.** January and February are written and in SOURCES.md. Method is a
