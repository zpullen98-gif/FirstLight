...
| `js/data-year-makers.js` | `MONTHS_MAKERS`, `Q_MAKERS` — the second track. **366 of 366 — complete** |
...
**The Makers: 366 of 366, complete and selectable.** Twelve months, every citation
verified before it entered the file, no maker appearing twice in the year, and a
picker in Settings that only offers a track once all 366 days exist.
It is built *clean*, not audited clean afterwards — motivational quotation is
