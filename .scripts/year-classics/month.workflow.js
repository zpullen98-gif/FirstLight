...
const LANES = [
  { key: 'philosophy',    short: 'phil', brief: 'Ancient and modern PHILOSOPHY: treatises, dialogues, meditations, aphorism-books, essays that argue a position. Plato to Camus, Pascal to Weil, the Upanishadic commentators to Wittgenstein. Not the banned Stoics and Chinese masters; not scripture.' },
  { key: 'poetry-drama',  short: 'poet', brief: 'POETRY and DRAMA: epic, lyric, sonnet, haiku, verse fable, and lines spoken on the stage. Homer, Sappho, Dante, the Tang poets, Bashō, Shakespeare, Donne, Blake, Dickinson, Rilke, Akhmatova, Neruda, Heaney. A stage line names the play, act and scene and the speaker.' },
  { key: 'fiction-essay', short: 'fict', brief: 'FICTION, ESSAY, CORRESPONDENCE and DIARY: novels and stories, reflective prose in the author\'s own voice, published letters, journals and notebooks. Cervantes, Austen, Tolstoy, Dostoevsky, Eliot, Woolf, Kafka, Baldwin, Morrison; Montaigne, Emerson, Orwell; Rilke to Kappus, Keats, Chekhov; Woolf\'s and Kafka\'s diaries, Pessoa.' },
